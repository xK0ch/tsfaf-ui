...
@Component({
  ...
  imports: [EventDetailPanel, Spinner],
...
export class Veranstaltungen {
  ...
  protected closeDetail(): void {
    /*
     * Beim Schliessen des Detail-Panels soll der User dort bleiben wo
     * er war, NICHT zum Seitenanfang springen. Das withInMemoryScrolling
     * (scrollPositionRestoration: 'enabled') im Router macht aber bei
     * jeder neuen Navigation einen scroll-to-top — auch bei reinen
     * Query-Param-Aenderungen.
     *
     * Workaround: scrollY speichern, navigieren, danach per setTimeout
     * (nach der Router-Scroll-Restoration) zurueck auf die alte Y-
     * Position scrollen. Das Modal hat body.style.overflow='hidden'
     * waehrend offen, scrollY ist also waehrend des Modal-Aufenthalts
     * korrekt erhalten.
     */
    ...
    void this.router
      ...
      .then(() => setTimeout(() => window.scrollTo(0, y), 0));
  }
